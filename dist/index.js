...
var SubscriptionService = /** @class */ (function () {
    function SubscriptionService(__observable) {
        this.__observable = __observable;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.__observable.subscribe(function (data) {
                                _this.__data = data;
                            })];
                    case 1:
                        _a.__subscription = _b.sent();
                        return [2 /*return*/];
                }
            });
        });
